...
Optional scope in parentheses describes the area of the change, for example `fix(safety): include active medications in interaction check`. The body explains what changed and why, never how. No `Co-authored-by`  trailer. No emoji. No em dashes.
