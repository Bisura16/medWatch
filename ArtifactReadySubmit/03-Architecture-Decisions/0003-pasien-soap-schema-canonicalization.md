...
- Mandat read-only untuk file di `anggota2/`..`anggota5/` (CLAUDE.md
...
sejalan dengan CLAUDE.md Rule 3 (table source-of-truth) yang menyatakan
...
- CLAUDE.md (root project) Rule 3 mendaftarkan
...
- Bidan workflow reality dan mapping field optional dijelaskan dalam
  CLAUDE.md section "Bidan workflow reality (Pasien input/display)".
