...
Field `data_json TEXT` menyimpan JSON payload aslinya (sesuai canonical schema di `.md` baris 95-105). Field top-level seperti `id`, `tanggal_kunjungan`, `owner_username` di-promote menjadi kolom terpisah untuk indexing.
